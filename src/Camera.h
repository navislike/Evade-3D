...
public:
	...
	void switchPathPosition(bool left, bool mid, bool right);

	bool getIsLeftSide();
	bool getIsRightSide();
	bool getIsMiddle();

	void setIsLeftSide(const bool left);
	void setIsRightSide(const bool right);
	void setIsMiddle(const bool mid);
